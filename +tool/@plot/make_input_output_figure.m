function make_input_output_figure(obj)
    ...
    for plot_member = obj.plot_list
        ...
        if strcmp(plot_member.data, "num_vehs") && strcmp(plot_member.type, "all")
            figure_struct = [];
            figure_struct.fig_obj = figure('Name', 'Number of Vehicles in the Network');
            ...
            figure_struct.p_obj = plot(obj.time_data, num_vehs_in_network, 'LineWidth', obj.line_width);
