function make_deltad_list(obj)
    ...
    for veh_id = 1:length(route_vehs.north)
        if veh_id == 1
            deltad_list = [deltad_list, last_index + 2];
        ...
        elseif route_vehs.north(veh_id) == 1 || route_vehs.north(veh_id) == 2
            if strcmp(first_veh_route, "right")
                deltad_list = [deltad_list, last_index + 4];
                first_veh_route = "done";
                last_index = last_index + 10;
            else
                deltad_list = [deltad_list, last_index + 6];
    ...
    obj.variables_list_map("delta_d") = {deltad_list};
